...
export enum DATABASE_STATISTICS {
...
export enum MESSAGE_FORWARD_ORIGIN {
...
export enum PAGE_BLOCK_HORIZONTAL_ALIGNMENT {
...
export enum PAGE_BLOCK_RELATED_ARTICLE {
  pageBlockRelatedArticle = 'pageBlockRelatedArticle'
}

export enum PAGE_BLOCK_TABLE_CELL {
  pageBlockTableCell = 'pageBlockTableCell'
}

export enum PAGE_BLOCK_VERTICAL_ALIGNMENT {
...
export enum PASSPORT_ELEMENTS_WITH_ERRORS {
